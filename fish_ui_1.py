...
class FishGame(arcade.View):
    ...
    def _draw_penguin(self, x: float, y: float, color):
        ...
        # Player color indicator - LARGE distinctive features
        if color == COLORS["red"]:
            # RED PLAYER: Large red scarf
            ...
            # WHITE/AI PLAYER: Large blue bowtie and cap
            # Bowtie
            bowtie_points = [
                (x - 8, y + 5),
                (x - 3, y + 5),
            ...
            arcade.draw_polygon_filled(bowtie_points, arcade.color.BLUE)
            arcade.draw_polygon_outline(bowtie_points, arcade.color.DARK_BLUE, 2)
            ...
            arcade.draw_polygon_filled(bowtie_points2, arcade.color.BLUE)
            arcade.draw_polygon_outline(bowtie_points2, arcade.color.DARK_BLUE, 2)
            
            # Center knot
            arcade.draw_circle_filled(x, y + 5, 3, arcade.color.DARK_BLUE)
